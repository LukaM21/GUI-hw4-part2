/*
 ...
 Author: Luka Metias
 HW4 Part 2
 Description: This JavaScript file uses jQuery to read user inputs, then it validate them using the jQuery Validation plugin,
and then after it will generate a multiplication table based on those inputs. The table is dynamically generated within the specified
HTML container. this part of the hw has the tabs, and we are able to add multiple tables as tabs, and delete selected tabs.
*/
